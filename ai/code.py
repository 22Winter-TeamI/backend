...
fpath = Path('/Users/kimich/Documents/Developer/TeamI-Backend/backend/ai/pretrained_model/Paprika_net_G_float.pth').absolute()
...
def picture(image):
    ...
    plt.imshow(img_output[:,:,::-1])
    plt.savefig('savefig_default.png')    
    # print(FileResponse("./savefig_default.png"))
    return img_output